      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-start lg:gap-8">
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
              ...
              <form className="w-full">
                ...
                <FadeInSection direction="in">
                  <div className="border border-gray-100 p-2 focus-within:ring-3 sm:flex sm:items-center sm:gap-4">
                    ...
                    <button className="mt-1 w-full bg-orange-500 px-6 py-3 text-sm font-bold tracking-wide text-white uppercase transition-none hover:bg-orange-600 sm:mt-0 sm:w-auto sm:shrink-0">
                      Sign Up
                    </button>
                  </div>
                </FadeInSection>
            ...
            <div className="col-span-2 sm:col-span-1">
              <FadeInSection direction="in">
                <p className="font-medium text-white-900">Downloads</p>
              </FadeInSection>
            ...
            <ul className="mt-8 flex flex-wrap justify-start gap-4 text-xs sm:mt-0 lg:justify-end">
              <FadeInSection direction="in">
                <li>
                  <a
                    href="#"
                    className="text-white-500 transition hover:opacity-75"
                  >
                    {" "}
                    Terms & Conditions{" "}
                  </a>
