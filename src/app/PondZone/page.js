              ...
              <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                <div className="relative pl-16">
                  <dt className="text-base/7 font-semibold text-white-900">
                    ...
                    <FadeInSection direction="in">Push to deploy</FadeInSection>
                  </dt>
                  <FadeInSection direction="in">
                    <dd className="mt-2 text-base/7 text-white-600">
                ...
                <div className="relative pl-16">
                  <dt className="text-base/7 font-semibold text-white-900">
                    ...
                    <FadeInSection direction="in">Simple queues</FadeInSection>
                  </dt>
                  <FadeInSection direction="in">
                    <dd className="mt-2 text-base/7 text-white-600">
