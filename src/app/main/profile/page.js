...
export default function Profile() {
  ...
  return (
    ...
    >
      <Background1 />
      <div className="max-w-4xl flex items-stretch flex-wrap mx-auto my-32">
        <div
          id="profile"
        ...
        >
          <div className="p-4 md:p-12 text-center lg:text-left">
            ...
            <div className="flex gap-55 pt-12 pb-8 ">
              <h1 className="text-gray-900 dark:text-gray-100 text-3xl font-bold pt-8 lg:pt-0 ">
                Your Name
              </h1>
        ...
        <div className="w-full lg:w-2/5">
          <Image
            ...
            alt="bg"
            className="w-full h-full object-cover rounded-lg lg:rounded-l-lg lg:rounded-l-none shadow-2xl hidden lg:block"
            width={1000}
            height={1000}
          />
        </div>
